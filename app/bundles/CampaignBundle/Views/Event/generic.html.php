...
?>
<?php if (empty($update)): ?>
<div id="CampaignEvent_<?php echo $event['id'] ?>" data-type="<?php echo $event['eventType']; ?>" class="draggable list-campaign-event list-campaign-<?php echo $event['eventType']; ?>" data-event="<?php echo $event['type']; ?>" data-toggle="tooltip" data-original-title="<?php echo $event['name'] ?>">
<?php endif; ?>
