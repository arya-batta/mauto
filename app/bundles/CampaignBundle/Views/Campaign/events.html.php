        ...
        <li class="list-group-item bg-auto bg-light-xs">
            ...
            <div class="box-layout">
                ...
                <span class="mt-xs label label-warning" data-toggle="tooltip" title="<?php echo $view['translator']->trans('mautic.report.campaign.completed.actions'); ?>"><?= $event['logCount']; ?></span> <span class="mt-xs label label-default"  data-toggle="tooltip" title="<?php echo $view['translator']->trans('mautic.report.campaign.pending.actions'); ?>"><?= $event['leadCount'] - $event['logCount']; ?></span>
                    ...
                    <div class="<?php  echo'action' !== $event['eventType']? 'col-md-7' : 'col-md-8'; ?>  va-m" style="width:<?php  echo'action' !== $event['eventType']? '64.33333%' : '72%'; ?> " >

                    <h5 class="fw-sb text-primary mb-xss">
                        <?php echo $event['name'] ?>
                   ...
                   <!-- <h6 class="text-white dark-sm"><em class="text-white dark-sm"> --><?php //echo $view['translator']->trans('mautic.campaign.'.$event['type']); ?> <!--</em></h6> -->
                </div>
                <div class="col-md-3 va-m text-right hide">
