...
class CampaignModel extends CommonFormModel
{
    ...
    public function getCampaignsBlocks()
    {
        ...
        $activeCampaigns = [$this->translator->trans('le.form.display.color.blocks.green'), 'fa fa-cogs', $this->translator->trans('mautic.campaign.campaigns.activel'),
        ...
        $inactiveCampaigns = [$this->translator->trans('le.form.display.color.blocks.red'), 'fa fa-cogs', $this->translator->trans('mautic.campaign.campaigns.inactive'),
