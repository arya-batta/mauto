...
//        $this->getEntityManager()->clear(Lead::class);
    ...
    {
        $totalCampaigns =  [$this->translator->trans('le.form.display.color.blocks.blue'), 'mdi mdi-shape-plus', $this->translator->trans('mautic.campaign.campaigns.all'),
        ...
        $activeCampaigns = [$this->translator->trans('le.form.display.color.blocks.green'), 'mdi mdi-shape-plus', $this->translator->trans('mautic.campaign.campaigns.activel'),
        ...
        $inactiveCampaigns = [$this->translator->trans('le.form.display.color.blocks.red'), 'mdi mdi-shape-plus', $this->translator->trans('mautic.campaign.campaigns.inactive'),
