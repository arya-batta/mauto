        ...
        <div>
            ...
            <div class="row row-padding" style="text-align: center">
                <div class="col-sm-4">
                    ...
                    <img src="https://leadsengage.com/wp-content/uploads/leadsengage/icon-configuration.png">
                ...
                <div class="col-sm-4">
                    <div class="bg-white welcome-stats">
                    <img src="https://leadsengage.com/wp-content/uploads/leadsengage/icon-upload.png">
                        <div style="text-align: left;padding:15px;">
                            <ul class="todolist">
                ...
                <div class="col-sm-4">
                    <div class="bg-white welcome-stats">
                    <img src="https://leadsengage.com/wp-content/uploads/leadsengage/icon-send-email.png">
                        <div style="text-align: left;padding:15px;"
                            <ul class="todolist">
