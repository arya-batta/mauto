...
<head>
    ...
    <style>
        ...
        .bs-wizard > .bs-wizard-step > .bs-wizard-dot {position: absolute; width: 12px; height: 12px; display: block; background: #3292e0; top: 30px; left: 50%; margin-top: -15px; margin-left: -15px; border-radius: 50%;}
        ...
        .welcome-page-header{ padding-left:45% !important;}
        .btn-disabled{
            pointer-events: none;
...
<form novalidate="" autocomplete="false" data-toggle="ajax" role="form" name="welcome" method="post" action="<?php echo $view['router']->generate('le_welcome_action', ['step' => $step]); ?>">
    <div class="container">
        ...
        <input type="submit" id="continue-btn" class="btn" value="Continue">
    </div>
