...
<br>
<div style="width:100%;margin-top:1%;padding:10px;">
    ...
    <div class="row">
        <form novalidate="" id="firstTimeSetup_Form" autocomplete="false" data-toggle="ajax" role="form" name="welcome" method="post" action="<?php echo $view['router']->generate('le_welcome_action'); ?>">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <label style="width: 100%;" for="phone">Current Contact Size</label>
                        <select style="width: 100%;" name="welcome[currentlist]" class="selop" id="select_listsize">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="text" id="welcome_address" class="form-control le-input" name="welcome[address]" value="<?php echo $billing->getCompanyaddress(); ?>">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <label style="width: 100%;" for="country">Country</label>
                        <select style="width: 100%;" name="welcome[country]" class="selop" id="selectcountry">
