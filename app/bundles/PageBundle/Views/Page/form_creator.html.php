    ...
    <div class="modal-dialog le-gradient-align" >
        <div class="modal-contentle-modal-content" style="height: 360px">
            <div class="modal-header"style="background-color: white;">
                <a href="javascript: void(0);" onclick="Mautic.closePluginModel('bee-plugin-form-creator')" class="close" ><span aria-hidden="true">&times;</span></a>
                ...
                <div class="row">
                    <div>
                        <div class="modal-body">
                            ...
                            <a id="javascipt_textarea_atag" onclick="Mautic.copytoClipboardforms('javascipt_textarea_page');">
                            ...
                            <textarea style="height: 113px;max-height: 113px;" id="iframe_textarea_page" class="form-control" readonly onclick="Mautic.copytoClipboardforms(this);"></textarea>
                            <a id="iframe_textarea_atag" onclick="Mautic.copytoClipboardforms('iframe_textarea_page');"><i aria-hidden="true" class="fa fa-clipboard"></i>
                                <?php echo $view['translator']->trans(
                                    'leadsengage.subs.clicktocopy'
                                ); ?></a>
                            <br>
