    ...
    public function fieldProvider()
    {
        return [
            [
                ...
                '<input id="leform_input_mautic_firstname" value="" />',
                '<input id="leform_input_mautic_firstname" value="&quot;/&gt;alert(0)" />',
            ...
            [
                ...
                '<input id="leform_input_mautic_firstname" value="" />',
                '<input id="leform_input_mautic_firstname" value="&quot; onfocus=&quot;alert(123)" />',
                'Inline JS values should not be allowed via GET to prevent XSS.',
            ],
            [
                $this->getField('Description', 'textarea'),
                '%22%2F%3E%3Cscript%3Ealert%280%29%3C%2Fscript%3E',
                '<textarea id="leform_input_mautic_description"></textarea>',
                '<textarea id="leform_input_mautic_description">&quot;/&gt;alert(0)</textarea>',
            ...
            [
                ...
                '%22%20onfocus=%22alert(123)',
                '<textarea id="leform_input_mautic_description"></textarea>',
                '<textarea id="leform_input_mautic_description">&quot; onfocus=&quot;alert(123)</textarea>',
                'Tags should be stripped from textarea field values submitted via GET to prevent XSS.',
            ],
            [
                $this->getField('Checkbox Single', 'checkboxgrp'),
                'myvalue',
                '<input id="leform_checkboxgrp_checkbox1" value="myvalue"/><input id="leform_checkboxgrp_checkbox2" value="notmyvalue"/>',
                '<input id="leform_checkboxgrp_checkbox1" value="myvalue" checked /><input id="leform_checkboxgrp_checkbox2" value="notmyvalue"/>',
                'Single value checkbox groups should have their values set appropriately via GET.',
            ],
            [
                $this->getField('Checkbox Multi', 'checkboxgrp'),
                'myvalue|alsomyvalue',
                '<input id="leform_checkboxgrp_checkbox1" value="myvalue"/><input id="leform_checkboxgrp_checkbox2" value="alsomyvalue"/><input id="leform_checkboxgrp_checkbox3" value="notmyvalue"/>',
                '<input id="leform_checkboxgrp_checkbox1" value="myvalue" checked /><input id="leform_checkboxgrp_checkbox2" value="alsomyvalue" checked /><input id="leform_checkboxgrp_checkbox3" value="notmyvalue"/>',
                'Multi-value checkbox groups should have their values set appropriately via GET.',
            ],
            [
                $this->getField('Radio Single', 'radiogrp'),
                'myvalue',
                '<input id="leform_radiogrp_radio1" value="myvalue"/><input id="leform_radiogrp_radio1" value="notmyvalue"/>',
                '<input id="leform_radiogrp_radio1" value="myvalue" checked /><input id="leform_radiogrp_radio1" value="notmyvalue"/>',
                'Single value radio groups should have their values set appropriately via GET.',
            ],
            [
                $this->getField('Select', 'select'),
                'myvalue',
                '<select id="leform_input_mautic_select"><option value="myvalue">My Value</option></select>',
                '<select id="leform_input_mautic_select"><option value="myvalue" selected="selected">My Value</option></select>',
