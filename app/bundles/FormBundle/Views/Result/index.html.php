...
$view['slots']->set('leContent', 'formresult');
...
$buttons[] = [
    'attr' => [
        ...
        'href'        => $view['router']->path('le_form_export', ['objectId' => $form->getId(), 'format' => 'html']),
    ],
...
$buttons[] = [
    'attr' => [
        ...
        'data-toggle' => '',
        'class'       => 'btn btn-default btn-nospin',
        'href'        => $view['router']->path('le_form_export', ['objectId' => $form->getId(), 'format' => 'csv']),
    ],
...
if (class_exists('PHPExcel')) {
    $buttons[] = [
        'attr' => [
            ...
            'data-toggle' => '',
            'class'       => 'btn btn-default btn-nospin',
            'href'        => $view['router']->path('le_form_export', ['objectId' => $form->getId(), 'format' => 'xlsx']),
        ],
