...
<div class="box-layout mb-lg">
	...
	<div>
		<a class="btn btn-primary btn-leadnote-add pull-right blue-theme-bg" style="border-color: #E62163;"href="<?php echo $view['router']->path('le_contactnote_action', ['leadId' => $lead->getId(), 'objectAction' => 'new']); ?>" data-toggle="ajaxmodal" data-target="#leSharedModal" data-header="<?php echo $view['translator']->trans('le.lead.note.header.new'); ?>"><i class="fa fa-plus fa-lg"></i> <?php echo $view['translator']->trans('le.lead.add.note'); ?></a>
	</div>
</div>
