...
<div class="row condition-custom-date-row" style="display: none;">
        ...
        <div class="row">
            <div class="form-group col-xs-12 ">
                <div class="input-group">
                    ...
                    <input autocomplete="false" type="number" id="lead-field-custom-date-interval" class="form-control" value="1" onchange="Le.updateLeadFieldValueOptions(mQuery('#campaignevent_properties_value'), true)">
                </div>
            </div>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="row">
            <div class="form-group col-xs-12 ">
                <select id="lead-field-custom-date-unit" class="form-control chosen" autocomplete="false" onchange="Le.updateLeadFieldValueOptions(mQuery('#campaignevent_properties_value'), true)">
