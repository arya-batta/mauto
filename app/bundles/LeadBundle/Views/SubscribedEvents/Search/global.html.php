...
<?php if (!empty($showMore)): ?>
    <a href="<?php echo $view['router']->generate('le_contact_index', ['search' => $searchString]); ?>" data-toggle="ajax">
...
<?php else: ?>
    ...
    <a href="<?php echo $view['router']->generate('le_contact_action', ['objectAction' => 'view', 'objectId' => $lead->getId()]); ?>" data-toggle="ajax">
