...
<div class="col-md-12 <?php echo $offsetclass ?> mt-md" style="white-space: normal;">
    ...
    <h4 style="font-size: 18px;<?php echo $align ?>"><?php echo $view['translator']->trans($header); ?></h4>
