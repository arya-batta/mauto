...
class SidebarCanvasHelper extends Helper
{
    ...
    public function renderCanvasContent(PhpEngine $templating)
    {
        ...
        if (!$hasContent) {
            $this->content['main'] = [
                'header'  => false,
                'content' => '<span class="beamer_avoid" style="max-height: 0px;max-width: 0px;"></span><div class="mautibot-image"><img class="img-responsive mt-lg" style="margin-right: auto; margin-left: auto;" src="'.MautibotHelper::get('wave').'" /></div>',
                'footer'  => '',
            ];
        }
    }
