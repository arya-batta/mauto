...
<div class="sidebar-header">
    ...
    <!--/ logo figure -->
    <!-- logo text -->
    <!--<svg version="1.1" class="le-logo-text mnl-3" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 260 65" enable-background="new 0 0 260 65" xml:space="preserve">
        <g>
