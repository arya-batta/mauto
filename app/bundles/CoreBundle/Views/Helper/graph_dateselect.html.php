...
<?php echo $view['form']->start($dateRangeForm, ['attr' => ['class' => 'form-filter '.$class, 'style' => 'max-width: 400px']]); ?>
    <div class="input-group">
        ...
        <span class="input-group-btn graph-apply" style="top:-5px;" data-toggle="tooltip" title="" data-placement="top" data-original-title="<?php echo $view['translator']->trans('le.core.engagements.applybtn.tooltip'); ?>">
