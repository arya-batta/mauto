    ...
    <div class="col-md-3 theme-list">
        <div class="panel panel-default <?php echo $isCodeMode ? 'theme-selected' : ''; ?>">
            <div class="panel-body text-center">
                ...
                <a href="#" type="button" data-theme="<?php echo $codeMode; ?>" class="select-theme-link btn btn-default waves-effect <?php echo $isCodeMode ? 'hide' : '' ?>" onclick="mQuery('#dynamic-content-tab').removeClass('hidden')">
                    Select
                </a>
                <button type="button" class="select-theme-selected btn btn-default waves-effect <?php echo $isCodeMode ? '' : 'hide' ?>" disabled="disabled">
                    Selected
                </button>
            </div>
        </div>
        ...
        <div class="col-md-3 theme-list">
            <div class="panel panel-default <?php echo $isSelected ? 'theme-selected' : ''; ?>">
                <div class="panel-body text-center">
                    ...
                    <?php endif; ?>
                    <a href="#" type="button" data-theme="<?php echo $themeKey; ?>" class="select-theme-link btn btn-default waves-effect <?php echo $isSelected ? 'hide' : '' ?>" onclick="mQuery('#dynamic-content-tab').addClass('hidden')">
                        Select
                    </a>
                    <button type="button" class="select-theme-selected btn btn-default waves-effect <?php echo $isSelected ? '' : 'hide' ?>" disabled="disabled">
                        Selected
                    </button>
                </div>
            </div>
