...
<tr>
    <td width="20%"><span class="fw-b"><?php echo $view['translator']->trans('le.page.publish.up'); ?></span></td>
    <td><?php echo (!is_null($entity->getPublishUp())) ? $view['date']->toFull($entity->getPublishUp()) : $view['date']->toFull($entity->getDateAdded()); ?></td>
</tr>
<tr>
    <td width="20%"><span class="fw-b"><?php echo $view['translator']->trans('le.page.publish.down'); ?></span></td>
