...
$view['slots']->set('leContent', 'update');
        ...
        <div class="col-sm-offset-2 col-sm-8">
            ...
            <?php if (!$failed): ?>
                <div class="text-center">
                    <a href="<?php echo $view['router']->path('le_dashboard_index'); ?>" data-toggle="ajax"><?php echo $view['translator']->trans('mautic.core.go_to_dashboard'); ?></a>
                </div>
            <?php endif; ?>
        </div>
    </div>
