...
class PointModel extends CommonFormModel
{
    ...
    {
        $totalPoints =  [$this->translator->trans('le.form.display.color.blocks.blue'), 'mdi mdi-contrast-box', $this->translator->trans('mautic.point.rules.all'),
            $this->getRepository()->getTotalPointsCount($viewOthers = $this->factory->get('mautic.security')->isGranted('point:points:viewother')),
        ];
        $activePoints = [$this->translator->trans('le.form.display.color.blocks.green'), 'mdi mdi-contrast-box', $this->translator->trans('mautic.point.rules.active'),
        ...
        $inactivePoints = [$this->translator->trans('le.form.display.color.blocks.red'), 'mdi mdi-contrast-box', $this->translator->trans('mautic.point.rules.inactive'),
