...
<?php else: ?>
<?php if ($canEdit): ?>
        <a href="<?php echo $view['router']->generate('le_client_action', ['objectAction' => 'edit', 'objectId' => $client->getId()]); ?>" onclick="Le.closeGlobalSearchResults();" class="list-group-item" data-toggle="ajax">
            <div class="media">
