                ...
                <div class="box-layout">
                    ...
                    <div class="col-md-4 va-m">
                        <h5 class="fw-sb text-primary">
                            <a href="<?php echo $view['router']->path('le_campaign_action', ['objectAction' => 'edit', 'objectId' => $email['campaign_id']]); ?>" data-toggle="ajax">
                    ...
                    <div class="col-md-4 va-m text-right">
                        <a class="btn btn-sm btn-success"  href="<?php echo $view['router']->path('le_contact_action', ['objectAction' => 'view', 'objectId' => $email['lead_id']]); ?>" data-toggle="ajax">
