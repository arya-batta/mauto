...
namespace MauticPlugin\leSocialBundle\Helper;
...
use MauticPlugin\leSocialBundle\Exception\ExitMonitorException;
use MauticPlugin\leSocialBundle\Model\MonitoringModel;
use MauticPlugin\leSocialBundle\Model\PostCountModel;
...
class TwitterCommandHelper
{
     ...
     * @param int $mid
     *
     * @return \MauticPlugin\leSocialBundle\Entity\Monitoring
     */
    ...
    private function setMonitorLeadStat($monitor, $lead)
    {
        ...
        $monitorLead = new \MauticPlugin\leSocialBundle\Entity\Lead();
        $monitorLead->setMonitor($monitor);
        $monitorLead->setLead($lead);
        $monitorLead->setDateAdded(new \DateTime());

        /* @var \MauticPlugin\leSocialBundle\Entity\LeadRepository $monitorRepository */
        $monitorRepository = $this->em->getRepository('leSocialBundle:lead');
