...
namespace MauticPlugin\leSocialBundle\Model;

use Mautic\CoreBundle\Model\AjaxLookupModelInterface;
use Mautic\CoreBundle\Model\FormModel;
use Mautic\LeadBundle\Entity\Lead;
use MauticPlugin\leSocialBundle\Entity\Tweet;
use MauticPlugin\leSocialBundle\Entity\TweetStat;
use MauticPlugin\leSocialBundle\Event as Events;
use MauticPlugin\leSocialBundle\SocialEvents;
...
class TweetModel extends FormModel implements AjaxLookupModelInterface
{
    ...
    {
        return $this->em->getRepository('leSocialBundle:Tweet');
    }
    ...
    {
        return $this->em->getRepository('leSocialBundle:TweetStat');
    }
