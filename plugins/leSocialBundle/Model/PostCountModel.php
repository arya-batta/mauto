...
use MauticPlugin\leSocialBundle\Entity\PostCount;
...
class PostCountModel extends AbstractCommonModel
{
     ...
     *
     * @return \MauticPlugin\leSocialBundle\Entity\PostCountRepository
     */
    public function getRepository()
    {
        return $this->em->getRepository('leSocialBundle:PostCount');
    }
    ...
    public function updatePostCount($monitor, \DateTime $postDate)
    {
        ...
        /** @var \MauticPlugin\leSocialBundle\Entity\PostCountRepository $postCountsRepository */
        ...
        if (!count($postCounts)) {
            /** @var \MauticPlugin\leSocialBundle\Entity\PostCount $postCount */
