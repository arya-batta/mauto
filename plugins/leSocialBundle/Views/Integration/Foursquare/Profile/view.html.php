...
<div class="np panel-body tab-content">
    <div class="pa-20 tab-pane active" id="FoursquareProfile">
        <?php echo $view->render('leSocialBundle:Integration/Foursquare/Profile:profile.html.php', [
            'lead'    => $lead,
            'profile' => $details['profile'],
        ]); ?>
    </div>
    <div class="tab-pane" id="FoursquareTips">
        <?php echo $view->render('leSocialBundle:Integration/Foursquare/Profile:tips.html.php', [
            'lead'     => $lead,
