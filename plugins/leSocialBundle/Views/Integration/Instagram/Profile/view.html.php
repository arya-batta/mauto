...
<div class="np panel-body tab-content">
    <div class="pa-20 tab-pane active" id="InstagramProfile">
        <?php echo $view->render('leSocialBundle:Integration/Instagram/Profile:profile.html.php', [
            'profile' => $details['profile'],
        ]); ?>
    </div>
    <div class="pa-20 tab-pane" id="InstagramPhotos">
        <?php echo $view->render('leSocialBundle:Integration/Instagram/Profile:photos.html.php', [
