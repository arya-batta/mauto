...
<div class="panel-body tab-content">
    <div class="tab-pane active" id="GoogleProfile">
        <?php echo $view->render('leSocialBundle:Integration/GooglePlus/Profile:profile.html.php', [
            'lead'    => $lead,
            'profile' => $details['profile'],
        ]); ?>
    </div>
    <div class="tab-pane" id="GooglePosts">
        <?php echo $view->render('leSocialBundle:Integration/GooglePlus/Profile:posts.html.php', [
            'lead'     => $lead,
            'activity' => (!empty($details['activity']['posts'])) ? $details['activity']['posts'] : [],
        ]); ?>
    </div>
    <div class="tab-pane" id="GooglePhotos">
        <?php echo $view->render('leSocialBundle:Integration/GooglePlus/Profile:photos.html.php', [
            'lead'     => $lead,
            'activity' => (!empty($details['activity']['photos'])) ? $details['activity']['photos'] : [],
        ]); ?>
    </div>
    <div class="tab-pane" id="GoogleTags">
        <?php echo $view->render('leSocialBundle:Integration/GooglePlus/Profile:tags.html.php', [
            'lead'     => $lead,
