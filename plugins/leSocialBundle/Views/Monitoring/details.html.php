...
if (!$isEmbedded) {
    ...
    $view['slots']->set('actions', $view->render('MauticCoreBundle:Helper:page_actions.html.php', [
        ...
        'templateButtons' => [
            'edit'   => $view['security']->isGranted('plugin:leSocial:monitoring:edit'),
            'delete' => $view['security']->isGranted('plugin:leSocial:monitoring:delete'),
            'close'  => $view['security']->isGranted('plugin:leSocial:monitoring:view'),
        ],
        'routeBase'  => 'social',
        'langVar'    => 'monitoring',
        'nameGetter' => 'getTitle',
...
echo $view['assets']->includeScript('plugins/leSocialBundle/Assets/js/social.js');
?>
