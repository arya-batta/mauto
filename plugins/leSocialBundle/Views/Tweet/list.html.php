 ...
 */
if ($tmpl == 'index') {
    $view->extend('leSocialBundle:Tweet:index.html.php');
}
?>
<?php if (count($items)): ?>
            ...
            <tr>
                ...
                echo $view->render(
                    ...
                    [
                        ...
                        'templateButtons' => [
                            'delete' => $view['security']->isGranted('plugin:leSocial:tweet:delete'),
                        ],
                    ]
                );
                    ...
                    <td>
                        ...
                        echo $view->render(
                            ...
                            [
                                'item'            => $item,
                                'templateButtons' => [
                                    'edit'   => $view['security']->isGranted('plugin:leSocial:tweet:edit'),
                                    'delete' => $view['security']->isGranted('plugin:leSocial:tweet:delete'),
                                ],
                                'routeBase'  => 'mautic_tweet',
