...
class CompanyTest extends PipedriveTest
{
    ...
    public function testCreateCompanyWhenFeatureIsDisabled()
    {
        ...
        $this->client->request(
            'POST',
            '/s/companies/new?leUserLastActive=1&leLastNotificationId=',
            [
                'company' => [
    ...
    public function testUpdateCompanyWhenFeatureIsDisabled()
    {
        ...
        $this->client->request(
            'POST',
            's/companies/edit/'.$company->getId().'?leUserLastActive=1&leLastNotificationId=',
            [
                'company' => [
                    'companyname'     => $testName,
                    'companyaddress1' => $testAddress1,
    ...
    public function testDeleteCompanyWhenFeatureIsDisabled()
    {
        ...
        $this->client->request(
            'POST',
            's/companies/delete/'.$company->getId().'?leUserLastActive=1&leLastNotificationId=',
            []
        );
