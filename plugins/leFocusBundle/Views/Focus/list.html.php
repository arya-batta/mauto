 ...
 */
if ($tmpl == 'index') {
    $view->extend('leFocusBundle:Focus:index.html.php');
}
    ...
    <div class="panel-footer">
        <?php echo $view->render(
            ...
            [
                ...
                'page'       => $page,
                'limit'      => $limit,
                'baseUrl'    => $view['router']->path('le_focus_index'),
                'sessionVar' => 'focus',
            ]
        ); ?>
    </div>
