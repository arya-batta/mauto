...
namespace MauticPlugin\leFocusBundle;

/**
 * Class FocusEvents.
 *
 * Events available for leFocusBundle
 */
final class FocusEvents
{
     ...
     *
     * The event listener receives a MauticPlugin\leFocusBundle\Event\FocusEvent instance.
     *
     * @var string
     */
