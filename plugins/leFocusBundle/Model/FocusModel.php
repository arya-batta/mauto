...
namespace MauticPlugin\leFocusBundle\Model;
...
use MauticPlugin\leFocusBundle\Entity\Stat;
use MauticPlugin\leFocusBundle\Event\FocusEvent;
use MauticPlugin\leFocusBundle\FocusEvents;
...
class FocusModel extends FormModel
{
     ...
     * {@inheritdoc}
     *
     * @return \MauticPlugin\leFocusBundle\Entity\FocusRepository
     */
    public function getRepository()
    {
        return $this->em->getRepository('leFocusBundle:Focus');
    }

    /**
     * {@inheritdoc}
     *
     * @return \MauticPlugin\leFocusBundle\Entity\StatRepository
     */
    public function getStatRepository()
    {
        return $this->em->getRepository('leFocusBundle:Stat');
    }
    ...
    public function generateJavascript(Focus $focus, $isPreview = false, $byPassCache = false)
    {
        ...
        if ($isPreview || $byPassCache || empty($cached) || !isset($cached['js'])) {
            ...
            $javascript = $this->templating->getTemplating()->render(
                'leFocusBundle:Builder:generate.js.php',
                [
                    'focus'    => $focusArray,
                    'preview'  => $isPreview,
                    'clickUrl' => $url,
        ...
        $focusContent = $this->templating->getTemplating()->getEngine('leFocusBundle:Builder:content.html.php')->escape($focusContent, 'js');
    ...
    public function getContent(array $focus, $isPreview = false, $url = '#')
    {
        ...
        $content = $this->templating->getTemplating()->render(
            'leFocusBundle:Builder:content.html.php',
            [
                'focus'    => $focus,
                'preview'  => $isPreview,
                'htmlMode' => $htmlMode,
        ...
        $formContent = (!empty($form)) ? $this->templating->getTemplating()->render(
            'leFocusBundle:Builder:form.html.php',
            [
                'form'    => $form,
                'style'   => $focus['style'],
                'focusId' => $focus['id'],
